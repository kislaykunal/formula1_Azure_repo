...
qualify_with_date_df = add_ingestion_date(qualifying_df)
...
final_df = qualify_with_date_df.withColumnRenamed("qualifyId", "qualify_id") \
...
# display(spark.read.parquet("/mnt/formula1dl59/processed/qualifying"))
